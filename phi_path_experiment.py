...
import argparse
import copy
from path_experiment import *
import gc
import time

BATCH_NUM = 1
qa_model = None
GPU_MAP = {0: "30GiB", 1: "0GiB", 2: "0GiB", 3: "30GiB", "cpu":"120GiB"}
INPUT_DEVICE = 'cuda:0'
...
def load_model(model_name="microsoft/Phi-3-mini-128k-instruct", only_tokenizer=False, gpu_map={0: "26GiB", 1: "0GiB", 2: "0GiB", 3: "0GiB", "cpu":"120GiB"}, quant_type=None):
    ...
    if not only_tokenizer:
        if quant_type is not None:
            ...
            model = AutoModelForCausalLM.from_pretrained(model_name, device_map='auto', max_memory=gpu_map, torch_dtype=torch.float16, trust_remote_code=True, attn_implementation='eager')
